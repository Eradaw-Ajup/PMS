...
public class ApiResponse {
	...
	public static final String DELETE_ASSOCIATION_SUCCESS = "association deleted";
	...
	public static final String UPDATE_ASSET_SUCCESS = "Asset updated";
	public static final String DELETE_ASSET_SUCCESS = "Asset deleted";
	public static final String CREATE_POLICY_SUCCESS = "Policy created";
	public static final String UPDATE_POLICY_SUCCESS = "Updated policy";
	public static final String ACTIVATE_POLICY_SUCCESS = "Policy activated";
	public static final String DE_ACTIVATE_POLICY_SUCCESS = "Policy de-activated";
	public static final String POLICY_PUBLISH_SUCCESS = "Policy published successfully";

	public static final String REVOKE_CONSENT_SUCCESS = "consent revoked";
	public static final String PROVIDE_CONSENT_SUCCESS = "consent provided";
	...
	public static class Builder implements Serializable {
		...
		/**
		 * This method returns a Builder that has the given error response code and
		 * message.
		 *
		 * @param e The exception that represents the error. The exception's error code
		 *          and message will be added to the Builder.
		...
		public Response build() {
			...
			// The JAX-RS response code will always be 200, The ApiResponse will have an
