...
public class AnalyticsService extends Service {
    ...
    public AnalyticsService(long userID, String owner) throws PMException {
        super(userID, owner);
    }
	...
	public AnalyticsService(String owner) throws PMException {
		super(owner);
		// TODO Auto-generated constructor stub
	}
    ...
    private HashSet<Long> inMemFindPcSet(Long nodeID, NodeType type) throws PMException {
        ...
        while (!queue.isEmpty()) {
            ...
            if (!visited.contains(crtNode)) {
                ...
                for (Long n : hsContainers) {
                    if(getGraphPAP().getPC().contains(n)) {
                        reachable.add(n);
                    } else {
                        queue.add(n);
                    }
