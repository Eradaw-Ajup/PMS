...
public class Constants {
	...
	//Attribute Types
	public static final String GROUP_ATTRIBUTE = "GA";
	public static final String RESOURCE_ATTRIBUTE = "RA";

	public static final String RESOURCE_IS_PROTECTED = "protected";
	public static final String RESOURCE_NOT_PROTECTED = "un-protected";
    ...
    public static final String CONSENTER_PROPERTY 					= "consenter";
    public static final String CONSENTEE_PROPERTY 					= "consentee";
    ...
    public static final String PROHIBITIONS_PROPERTY 				= "prohibitions";
    ...
    public static final String RECEIVED_CONSENTS					= "received_consents";
    public static final String APPROVED_CONSENTS					= "approved_consents";
    public static final String ALL_CONSENTS							= "all_consents";
}
